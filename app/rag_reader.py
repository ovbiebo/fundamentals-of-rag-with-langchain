...
import base64
from html_templates import expander_css, css, bot_template, user_template
...
def process_file(doc):
    ...
    pdfsearch = Chroma.from_documents(doc, OpenAIEmbeddings(), persist_directory="./chroma_db")
...
def handle_userinput(query):
    response = st.session_state.conversation.invoke({"question": query, 'chat_history': st.session_state.chat_history},
